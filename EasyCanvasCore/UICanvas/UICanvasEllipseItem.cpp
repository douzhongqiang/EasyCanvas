...
UICanvasEllipseItem::UICanvasEllipseItem(QGraphicsItem* parentItem)
    :UICanvasItemBase(parentItem)
{
    initAttribute();
}

UICanvasEllipseItem::~UICanvasEllipseItem()
{

}

void UICanvasEllipseItem::setSize(int width, int height)
{
...
void UICanvasEllipseItem::customPaint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    painter->save();
...
void UICanvasEllipseItem::initAttribute()
{
    ...
    // 连接信号和槽
    QObject::connect(m_pBRoundAttribute, &NDBoolAttribute::valueChanged, this, &UICanvasEllipseItem::onRoundValueChanged);
    QObject::connect(m_pBFillAttribute, &NDBoolAttribute::valueChanged, this, &UICanvasEllipseItem::onValueChanged);
    QObject::connect(m_pFillColorAttribute, &NDColorAttribute::valueChanged, this, &UICanvasEllipseItem::onValueChanged);
    QObject::connect(m_pBOutLineAttribute, &NDBoolAttribute::valueChanged, this, &UICanvasEllipseItem::onValueChanged);
    QObject::connect(m_pOutLineWidthAttribute, &NDIntAttribute::valueChanged, this, &UICanvasEllipseItem::onValueChanged);
    QObject::connect(m_pOutLineColorAttribute, &NDColorAttribute::valueChanged, this, &UICanvasEllipseItem::onValueChanged);

}

void UICanvasEllipseItem::onValueChanged(void)
{
    this->update();
}
